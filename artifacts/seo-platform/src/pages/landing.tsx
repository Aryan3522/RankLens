...
import { BarChart2, Search, Key, FileText, TrendingUp, Globe, ArrowRight, CheckCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <Link href="/dashboard">
            <Button size="sm" data-testid="button-get-started-header">Open Dashboard</Button>
          </Link>
        </div>
      </header>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-24 text-center">
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap">
          <Link href="/dashboard">
            <Button size="lg" className="gap-2 text-base px-7 py-5" data-testid="button-hero-cta">
              Go to Dashboard
