...
import { db, keywordsTable, keywordRankHistoryTable } from "../db";
import { CreateKeywordBody, ListKeywordsQueryParams, DeleteKeywordParams, GetKeywordHistoryParams } from "../types/generated/api";
